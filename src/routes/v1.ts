...
router.get(pathPrefix + '/v1/resolver/events', handleRequest(Controllers.ResolverController, "events", handlerOpts));
...
export const actionToRouteMap = {
	...
	"ResolverController.events": 'get /v1/resolver/events',
};
